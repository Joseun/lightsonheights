...
from evidently.metrics import ColumnDriftMetric, DatasetDriftMetric, \
					DatasetMissingValuesMetric, TextDescriptorsDriftMetric
import argparse
...
def calculate_metrics(reference_data_path: str, current_data):
	...
	reference_data['corpus'] = raw_data['author'] + ' ' + \
								raw_data['title'] + ' ' + \
								raw_data['text'] + ' ' + \
								raw_data['language'] + ' ' + \
								raw_data['site_url'] + ' ' + \
...
if __name__ == '__main__':
	...
	parser.add_argument('--train_data_path', required=True, help='Location of train data')
